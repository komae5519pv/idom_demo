...
from idom_car_ai.backend.models import Customer, CustomerInsight, CustomerInteraction, APIResponse
from idom_car_ai.backend.config import get_full_table_name
from idom_car_ai.backend.demo_data import (
